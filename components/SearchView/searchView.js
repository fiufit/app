      ...
      <>
        <View style={styles.container}>
          ...
          >
            ...
            {!userSearchSelected &&
                (trainingSearchData[trainingDifficulty][searchValue] ? (
                    trainingSearchData[trainingDifficulty][searchValue].map((item) => {
                      return (
                          <TouchableOpacity
                              style={styles.searchCard}
                              key={item.ID}
        ...
        {showFilterModal && <TrainingFilterModal onClose={() => setShowFilterModal(false)} trainingDifficulty={trainingDifficulty} setDifficulty={setTrainingDifficulty}/>}
      </>
